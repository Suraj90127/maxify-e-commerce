...
const Headers = () => {
  ...
  const [subcategorisData, setSubcategorisData] = useState([]);
  const [subCategoryShow, setsubCategoryShow] = useState(false);
  const [subCategoryDropdown, setsubCategoryDropdown] = useState();
  const [showSunCategorySidebar, setshowSunCategorySidebar] = useState(false);

  // console.log("ccccccccccaa", subCategoryData);
  ...
  return (
    <div className="w-full bg-white">
                    ...
                    return (
                      <div>
                        <li
                          ...
                          // }}
                          onClick={() => {
                            setsubCategoryDropdown(i);
                            setshowSunCategorySidebar(!showSunCategorySidebar);
                          }}
                        >
                          <img
                            src={c.image}
                                  ...
                                  <div
                                    className={`transition-all duration-500 ${
                                      showSunCategorySidebar
                                        ? "ease-in opacity-100 max-h-96"
                                        : "ease-out opacity-0 max-h-0"
                                    } overflow-hidden`}
                                  >
                                    {c.subCategory.map((subitem, index) => (
                                      ...
                                      >
                                        <Link
                                          to={`/products?category=${subitem.sname}`}
                                        >
                                          {subitem.sname}
                                        </Link>
                                      </div>
      ...
      {/* show sub category */}
      <div className="subcategoris md-lg:hidden">
        {/* showSubCategory */}
        {subcategorisData.length > 0 && subCategoryShow && (
          <div
            className={`${
